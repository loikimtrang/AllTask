...
public class DataLocalManager {
    ...
    public static void setListMarker(Set<String> listMarker) {
        DataLocalManager.getInstance().mySharedPreferences.putStringSetValue(PREF_LIST_MARKER, listMarker);
    }

    public static Set<String> getListMarker() {
        return DataLocalManager.getInstance().mySharedPreferences.getStringSetValue(PREF_LIST_MARKER);
    }
}
